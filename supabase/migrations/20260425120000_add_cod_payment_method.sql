...
ADD COLUMN payment_method text NOT NULL DEFAULT 'online'::text 
CHECK (payment_method = ANY (ARRAY['online'::text, 'cod'::text]));

-- Recreate the admin_orders_flat view to include payment_method
DROP VIEW IF EXISTS admin_orders_flat;
