              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  ...
                  <button 
                    ...
                    className="bg-white bg-opacity-90 backdrop-blur p-2 rounded-full hover:bg-rose-gold hover:text-white transition-all duration-300"
                  >
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-gradient-to-r from-rose-gold to-copper text-white py-2 sm:py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
                  >
                    Add to Cart
                  </button>
                </div>
